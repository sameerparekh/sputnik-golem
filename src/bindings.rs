...
impl ::core::fmt::Debug for Error {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        match self {
            Error::DuplicateId(e) => f.debug_tuple("Error::DuplicateId").field(e).finish(),
        }
    }
}
...
const _: () = {
    ...
    const _: () = {
        #[doc(hidden)]
        #[export_name = "cabi_post_place-order"]
        #[allow(non_snake_case)]
        unsafe extern "C" fn __post_return_place_order(arg0: i32) {
            ...
            match l0 {
                0 => {
                    ...
                    let base3 = l1;
                    let len3 = l2;
                    wit_bindgen::rt::dealloc(base3, (len3 as usize) * 32, 8);
                }
                _ => (),
            }
        }
...
const _: () = {
    ...
    const _: () = {
        #[doc(hidden)]
        #[export_name = "cabi_post_get-order-book"]
        #[allow(non_snake_case)]
...
const _: () = {
    ...
    const _: () = {
        #[doc(hidden)]
        #[export_name = "cabi_post_get-order-status"]
        #[allow(non_snake_case)]
...
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 633] = [
    3, 0, 7, 101, 120, 97, 109, 112, 108, 101, 0, 97, 115, 109, 13, 0, 1, 0, 7, 174, 3, 1, 65, 2,
    1, 65, 24, 1, 113, 1, 12, 100, 117, 112, 108, 105, 99, 97, 116, 101, 45, 105, 100, 1, 119, 0,
    3, 0, 5, 101, 114, 114, 111, 114, 3, 0, 0, 1, 109, 2, 3, 98, 117, 121, 4, 115, 101, 108, 108,
    3, 0, 4, 115, 105, 100, 101, 3, 0, 2, 1, 114, 6, 2, 105, 100, 119, 9, 116, 105, 109, 101, 115,
    116, 97, 109, 112, 119, 4, 115, 105, 100, 101, 3, 5, 112, 114, 105, 99, 101, 119, 4, 115, 105,
    122, 101, 119, 6, 116, 114, 97, 100, 101, 114, 119, 3, 0, 5, 111, 114, 100, 101, 114, 3, 0, 4,
    1, 112, 5, 1, 114, 2, 4, 98, 105, 100, 115, 6, 4, 97, 115, 107, 115, 6, 3, 0, 10, 111, 114,
    100, 101, 114, 45, 98, 111, 111, 107, 3, 0, 7, 1, 109, 3, 4, 111, 112, 101, 110, 6, 102, 105,
    108, 108, 101, 100, 14, 112, 97, 114, 116, 105, 97, 108, 45, 102, 105, 108, 108, 101, 100, 3,
    0, 6, 115, 116, 97, 116, 117, 115, 3, 0, 9, 1, 114, 4, 5, 112, 114, 105, 99, 101, 119, 4, 115,
    105, 122, 101, 119, 14, 116, 97, 107, 101, 114, 45, 111, 114, 100, 101, 114, 45, 105, 100, 119,
    14, 109, 97, 107, 101, 114, 45, 111, 114, 100, 101, 114, 45, 105, 100, 119, 3, 0, 4, 102, 105,
    ...
    101, 119, 3, 0, 12, 111, 114, 100, 101, 114, 45, 115, 116, 97, 116, 117, 115, 3, 0, 14, 1, 106,
    1, 15, 1, 1, 1, 64, 1, 5, 111, 114, 100, 101, 114, 5, 0, 16, 4, 0, 11, 112, 108, 97, 99, 101,
    45, 111, 114, 100, 101, 114, 1, 17, 1, 64, 0, 0, 8, 4, 0, 14, 103, 101, 116, 45, 111, 114, 100,
    101, 114, 45, 98, 111, 111, 107, 1, 18, 1, 107, 15, 1, 64, 1, 2, 105, 100, 119, 0, 19, 4, 0,
    16, 103, 101, 116, 45, 111, 114, 100, 101, 114, 45, 115, 116, 97, 116, 117, 115, 1, 20, 4, 1,
    28, 99, 111, 109, 112, 111, 110, 101, 110, 116, 58, 103, 111, 108, 101, 109, 45, 116, 101, 115,
    116, 47, 101, 120, 97, 109, 112, 108, 101, 4, 0, 11, 13, 1, 0, 7, 101, 120, 97, 109, 112, 108,
    101, 3, 0, 0, 0, 93, 12, 112, 97, 99, 107, 97, 103, 101, 45, 100, 111, 99, 115, 0, 123, 34,
    119, 111, 114, 108, 100, 115, 34, 58, 123, 34, 101, 120, 97, 109, 112, 108, 101, 34, 58, 123,
    34, 100, 111, 99, 115, 34, 58, 34, 65, 110, 32, 101, 120, 97, 109, 112, 108, 101, 32, 119, 111,
    114, 108, 100, 32, 102, 111, 114, 32, 116, 104, 101, 32, 99, 111, 109, 112, 111, 110, 101, 110,
    116, 32, 116, 111, 32, 116, 97, 114, 103, 101, 116, 46, 34, 125, 125, 125, 0, 70, 9, 112, 114,
