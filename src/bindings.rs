...
impl ::core::fmt::Debug for Fill {
  fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
    f.debug_struct("Fill").field("price", &self.price).field("size", &self.size).field("taker-order-id", &self.taker_order_id).field("maker-order-id", &self.maker_order_id).finish()
  }
}
#[derive(Clone)]
