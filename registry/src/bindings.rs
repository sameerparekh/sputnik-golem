              ...
              Err(e) => { {
                *((ptr2 + 0) as *mut u8) = (1i32) as u8;
                match e {
                  ...
                  Error::AssetMismatch(e) => {
                    *((ptr2 + 8) as *mut u8) = (2i32) as u8;
                    let AssetMismatchDetails{ incoming_asset:incoming_asset9, expected_asset:expected_asset9, } = e;
                    let Asset{ id:id10, name:name10, decimals:decimals10, } = incoming_asset9;
                    *((ptr2 + 16) as *mut i64) = wit_bindgen::rt::as_i64(id10);
                    ...
                    *((ptr2 + 32) as *mut u8) = (wit_bindgen::rt::as_i32(decimals10)) as u8;
                    let Asset{ id:id12, name:name12, decimals:decimals12, } = expected_asset9;
                    *((ptr2 + 40) as *mut i64) = wit_bindgen::rt::as_i64(id12);
                    let vec13 = (name12.into_bytes()).into_boxed_slice();
                    let ptr13 = vec13.as_ptr() as i32;
                    let len13 = vec13.len() as i32;
                    ::core::mem::forget(vec13);
                    *((ptr2 + 52) as *mut i32) = len13;
                    *((ptr2 + 48) as *mut i32) = ptr13;
                    *((ptr2 + 56) as *mut u8) = (wit_bindgen::rt::as_i32(decimals12)) as u8;
                  },
                }
              } },
            };ptr2
...
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 1033] = [3, 0, 8, 114, 101, 103, 105, 115, 116, 114, 121, 0, 97, 115, 109, 13, 0, 1, 0, 7, 173, 3, 1, 65, 2, 1, 66, 22, 1, 114, 3, 2, 105, 100, 119, 4, 110, 97, 109, 101, 115, 8, 100, 101, 99, 105, 109, 97, 108, 115, 125, 4, 0, 5, 97, 115, 115, 101, 116, 3, 0, 0, 1, 114, 2, 14, 105, 110, 99, 111, 109, 105, 110, 103, 45, 97, 115, 115, 101, 116, 1, 14, 101, 120, 112, 101, 99, 116, 101, 100, 45, 97, 115, 115, 101, 116, 1, 4, 0, 22, 97, 115, 115, 101, 116, 45, 109, 105, 115, 109, 97, 116, 99, 104, 45, 100, 101, 116, 97, 105, 108, 115, 3, 0, 2, 1, 113, 3, 12, 100, 117, 112, 108, 105, 99, 97, 116, 101, 45, 105, 100, 1, 119, 0, 13, 110, 111, 45, 115, 117, 99, 104, 45, 97, 115, 115, 101, 116, 1, 119, 0, 14, 97, 115, 115, 101, 116, 45, 109, 105, 115, 109, 97, 116, 99, 104, 1, 3, 0, 4, 0, 5, 101, 114, 114, 111, 114, 3, 0, 4, 1, 114, 4, 2, 105, 100, 119, 4, 110, 97, 109, 101, 115, 9, 110, 117, 109, 101, 114, 97, 116, 111, 114, 1, 11, 100, 101, 110, 111, 109, 105, 110, 97, 116, 111, 114, 1, 4, 0, 18, 104, 121, 100, 114, 97, 116, 101, 100, 45, 115, 112, 111, 116, 45, 112, 97, 105, 114, 3, 0, 6, 1, 114, 4, 2, 105, 100, 119, 4, 110, 97, 109, 101, 115, 12, 110, 117, 109, 101, 114, 97, 116, 111, 114, 45, 105, 100, 119, 14, 100, 101, 110, 111, 109, 105, 110, 97, 116, 111, 114, 45, 105, 100, 119, 4, 0, 9, 115, 112, 111, 116, 45, 112, 97, 105, 114, 3, 0, 8, 1, 112, 1, 1, 64, 0, 0, 10, 4, 0, 10, 103, 101, 116, 45, 97, 115, 115, 101, 116, 115, 1, 11, 1, 112, 7, 1, 64, 0, 0, 12, 4, 0, 14, 103, 101, 116, 45, 115, 112, 111, 116, 45, 112, 97, 105, 114, 115, 1, 13, 1, 106, 1, 1, 1, 5, 1, 64, 1, 5, 97, 115, 115, 101, 116, 1, 0, 14, 4, 0, 9, 97, 100, 100, 45, 97, 115, 115, 101, 116, 1, 15, 1, 106, 1, 7, 1, 5, 1, 64, 1, 4, 112, 97, 105, 114, 9, 0, 16, 4, 0, 13, 97, 100, 100, 45, 115, 112, 111, 116, 45, 112,