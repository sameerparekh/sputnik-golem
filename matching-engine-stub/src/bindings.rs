            ...
            pub mod sputnik {
              pub mod matching_engine_stub {
                ...
                pub mod stub_matching_engine {
                  ...
                  pub type OrderBook = super::super::super::super::sputnik::matching_engine::api::OrderBook;
                  pub type OrderStatus = super::super::super::super::sputnik::matching_engine::api::OrderStatus;
                  ...
                  unsafe impl wit_bindgen::rt::RustResource for Api{
                    unsafe fn new(_rep: usize) -> u32 {
                      ...
                      #[cfg(target_arch = "wasm32")]
                      {
                        #[link(wasm_import_module = "[export]sputnik:matching-engine-stub/stub-matching-engine")]
                        extern "C" {
                  ...
                  const _: () = {
                    ...
                    #[allow(non_snake_case)]
                    unsafe extern "C" fn __export_method_api_place_order(arg0: i32,arg1: i64,arg2: i64,arg3: i32,arg4: i64,arg5: i64,arg6: i64,) -> i32 {
                      #[allow(unused_imports)]
                      use wit_bindgen::rt::{alloc, vec::Vec, string::String};
                  ...
                  const _: () = {
                    ...
                    #[allow(non_snake_case)]
                    unsafe extern "C" fn __export_method_api_cancel_order(arg0: i32,arg1: i64,) -> i32 {
                      #[allow(unused_imports)]
                      use wit_bindgen::rt::{alloc, vec::Vec, string::String};
                      ...
                      let result0 = <_ApiImpl as GuestApi>::cancel_order(wit_bindgen::rt::Resource::<Api>::lift_borrow(arg0 as u32 as usize), arg1 as u64);
                      let ptr1 = _RET_AREA.0.as_mut_ptr() as i32;
                      match result0 {
                        Ok(e) => { {
                          *((ptr1 + 0) as *mut u8) = (0i32) as u8;
                  ...
                  const _: () = {
                    ...
                    unsafe extern "C" fn __export_method_api_get_order_book(arg0: i32,) -> i32 {
                      ...
                      let result0 = <_ApiImpl as GuestApi>::get_order_book(wit_bindgen::rt::Resource::<Api>::lift_borrow(arg0 as u32 as usize));
                      let ptr1 = _RET_AREA.0.as_mut_ptr() as i32;
                      let super::super::super::super::sputnik::matching_engine::api::OrderBook{ bids:bids2, asks:asks2, } = result0;
                      let vec4 = bids2;
                      let len4 = vec4.len() as i32;
                  ...
                  const _: () = {
                    ...
                    #[allow(non_snake_case)]
                    unsafe extern "C" fn __export_method_api_get_order_status(arg0: i32,arg1: i64,) -> i32 {
                      #[allow(unused_imports)]
                      use wit_bindgen::rt::{alloc, vec::Vec, string::String};
                      ...
                      let result0 = <_ApiImpl as GuestApi>::get_order_status(wit_bindgen::rt::Resource::<Api>::lift_borrow(arg0 as u32 as usize), arg1 as u64);
                      let ptr1 = _RET_AREA.0.as_mut_ptr() as i32;
                      match result0 {
                        Some(e) => {
                          *((ptr1 + 0) as *mut u8) = (1i32) as u8;
