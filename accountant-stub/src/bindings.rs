            ...
            pub mod sputnik {
              pub mod accountant_stub {
                ...
                pub mod stub_accountant {
                  ...
                  pub type OrderStatus = super::super::super::super::sputnik::accountant::api::OrderStatus;
                  ...
                  unsafe impl wit_bindgen::rt::RustResource for Api{
                    unsafe fn new(_rep: usize) -> u32 {
                      ...
                      #[cfg(target_arch = "wasm32")]
                      {
                        #[link(wasm_import_module = "[export]sputnik:accountant-stub/stub-accountant")]
                        extern "C" {
                  ...
                  const _: () = {
                    ...
                    #[allow(non_snake_case)]
                    unsafe extern "C" fn __export_method_api_initialize(arg0: i32,arg1: i64,arg2: i32,arg3: i32,arg4: i32,arg5: i32,arg6: i32,arg7: i32,) -> i32 {
                      #[allow(unused_imports)]
                      use wit_bindgen::rt::{alloc, vec::Vec, string::String};
                      ...
                      let result3 = <_ApiImpl as GuestApi>::initialize(wit_bindgen::rt::Resource::<Api>::lift_borrow(arg0 as u32 as usize), arg1 as u64, wit_bindgen::rt::string_lift(bytes0), wit_bindgen::rt::string_lift(bytes1), wit_bindgen::rt::string_lift(bytes2));
                  ...
                  const _: () = {
                    ...
                    unsafe extern "C" fn __export_method_api_get_balances(arg0: i32,) -> i32 {
                      ...
                      let result0 = <_ApiImpl as GuestApi>::get_balances(wit_bindgen::rt::Resource::<Api>::lift_borrow(arg0 as u32 as usize));
                  ...
                  const _: () = {
                    ...
                    #[allow(non_snake_case)]
                    unsafe extern "C" fn __export_method_api_place_order(arg0: i32,arg1: i64,arg2: i64,arg3: i64,arg4: i32,arg5: i64,arg6: i64,) -> i32 {
                      #[allow(unused_imports)]
                      use wit_bindgen::rt::{alloc, vec::Vec, string::String};
                  ...
                  const _: () = {
                    ...
                    #[allow(non_snake_case)]
                    unsafe extern "C" fn __export_method_api_deposit(arg0: i32,arg1: i64,arg2: i64,) -> i32 {
                      #[allow(unused_imports)]
                      use wit_bindgen::rt::{alloc, vec::Vec, string::String};
                      ...
                      let result0 = <_ApiImpl as GuestApi>::deposit(wit_bindgen::rt::Resource::<Api>::lift_borrow(arg0 as u32 as usize), arg1 as u64, arg2 as u64);
                      let ptr1 = _RET_AREA.0.as_mut_ptr() as i32;
                      match result0 {
                        Ok(e) => { {
                          *((ptr1 + 0) as *mut u8) = (0i32) as u8;
                  ...
                  const _: () = {
                    ...
                    #[allow(non_snake_case)]
                    unsafe extern "C" fn __export_method_api_withdraw(arg0: i32,arg1: i64,arg2: i64,) -> i32 {
                      #[allow(unused_imports)]
                      use wit_bindgen::rt::{alloc, vec::Vec, string::String};
                      ...
                      let result0 = <_ApiImpl as GuestApi>::withdraw(wit_bindgen::rt::Resource::<Api>::lift_borrow(arg0 as u32 as usize), arg1 as u64, arg2 as u64);
                      let ptr1 = _RET_AREA.0.as_mut_ptr() as i32;
                      match result0 {
                        Ok(e) => { {
                          *((ptr1 + 0) as *mut u8) = (0i32) as u8;
                  ...
                  const _: () = {
                    ...
                    #[allow(non_snake_case)]
                    unsafe extern "C" fn __export_method_api_process_maker_fill(arg0: i32,arg1: i64,arg2: i64,arg3: i64,arg4: i64,arg5: i64,) {
                      #[allow(unused_imports)]
                      use wit_bindgen::rt::{alloc, vec::Vec, string::String};
                      ...
                      <_ApiImpl as GuestApi>::process_maker_fill(wit_bindgen::rt::Resource::<Api>::lift_borrow(arg0 as u32 as usize), super::super::super::super::sputnik::matching_engine::api::Fill{
                        price: arg1 as u64,
                        size: arg2 as u64,
                  ...
                  pub trait GuestApi {
                    ...
                    fn initialize(&self,id: u64,matching_engine_template_id: wit_bindgen::rt::string::String,registry_template_id: wit_bindgen::rt::string::String,environment: wit_bindgen::rt::string::String,) -> Result<u64,Error>;
