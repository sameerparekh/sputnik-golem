                ...
                pub mod stub_accountant {
                  ...
                  const _: () = {
                    ...
                    unsafe extern "C" fn __export_method_api_get_orders(arg0: i32,) -> i32 {
                      ...
                      let result0 = <_ApiImpl as GuestApi>::get_orders(wit_bindgen::rt::Resource::<Api>::lift_borrow(arg0 as u32 as usize));
                      let ptr1 = _RET_AREA.0.as_mut_ptr() as i32;
                      let vec6 = result0;
                      let len6 = vec6.len() as i32;
