            ...
            pub mod sputnik {
              pub mod accountant {
                ...
                pub mod api {
                  ...
                  pub type EngineStatus = super::super::super::super::sputnik::matching_engine::api::OrderStatus;
                  ...
                  const _: () = {
                    ...
                    unsafe extern "C" fn __export_get_orders() -> i32 {
                      ...
                      for (i, e) in vec6.into_iter().enumerate() {
                        ...
                        {
                          let OrderAndStatus{ order:order2, status:status2, } = e;
                          let Order{ id:id3, spot_pair:spot_pair3, timestamp:timestamp3, side:side3, price:price3, size:size3, } = order2;
                          *((base + 0) as *mut i64) = wit_bindgen::rt::as_i64(id3);
