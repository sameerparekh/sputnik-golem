                ...
                pub mod api {
                  ...
                  const _: () = {
                    ...
                    unsafe extern "C" fn __export_deposit(arg0: i64,arg1: i64,) -> i32 {
                      ...
                      let ptr1 = _RET_AREA.0.as_mut_ptr() as i32;
                      let AssetBalance{ asset:asset2, balance:balance2, available_balance:available_balance2, } = result0;
                      let super::super::super::super::sputnik::registry::api::Asset{ id:id3, name:name3, decimals:decimals3, } = asset2;
                      ...
                      *((ptr1 + 32) as *mut i64) = wit_bindgen::rt::as_i64(available_balance2);
                      ptr1
                    }
