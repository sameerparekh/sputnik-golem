                      ...
                      pub mod sputnik {
                        pub mod accountant {
                          ...
                          pub mod api {
                            ...
                            pub trait Guest {
                              fn initialize(id: u64,matching_engine_component_id: wit_bindgen::rt::string::String,registry_component_id: wit_bindgen::rt::string::String,environment: wit_bindgen::rt::string::String,) -> Result<u64,Error>;
