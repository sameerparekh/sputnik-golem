                          ...
                          pub mod api {
                            ...
                            impl ::core::fmt::Debug for Error {
                              fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
                                match self {
                                  Error::BlockSeen(e) => {
                                    f.debug_tuple("Error::BlockSeen").field(e).finish()
                                  }
                                  Error::TxSeen(e) => {
