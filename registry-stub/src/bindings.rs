                ...
                pub mod stub_registry {
                  ...
                  const _: () = {
                    ...
                    unsafe extern "C" fn __export_method_api_get_traders(arg0: i32,) -> i32 {
                      ...
                      let result0 = <_ApiImpl as GuestApi>::get_traders(wit_bindgen::rt::Resource::<Api>::lift_borrow(arg0 as u32 as usize));
                      let ptr1 = _RET_AREA.0.as_mut_ptr() as i32;
                      let vec4 = result0;
                      let len4 = vec4.len() as i32;
                      ...
                      for (i, e) in vec4.into_iter().enumerate() {
                        ...
                        {
                          let super::super::super::super::sputnik::registry::api::Trader{ id:id2, name:name2, } = e;
                          *((base + 0) as *mut i64) = wit_bindgen::rt::as_i64(id2);
                          let vec3 = (name2.into_bytes()).into_boxed_slice();
                          let ptr3 = vec3.as_ptr() as i32;
                          let len3 = vec3.len() as i32;
                  ...
                  const _: () = {
                    ...
                    #[allow(non_snake_case)]
                    unsafe extern "C" fn __export_method_api_add_spot_pair(arg0: i32,arg1: i64,arg2: i32,arg3: i32,arg4: i64,arg5: i64,) -> i32 {
                      #[allow(unused_imports)]
                      use wit_bindgen::rt::{alloc, vec::Vec, string::String};
                      ...
                      let len0 = arg3 as usize;
                      let bytes0 = Vec::from_raw_parts(arg2 as *mut _, len0, len0);
                      let result1 = <_ApiImpl as GuestApi>::add_spot_pair(wit_bindgen::rt::Resource::<Api>::lift_borrow(arg0 as u32 as usize), super::super::super::super::sputnik::registry::api::SpotPair{
                        id: arg1 as u64,
                        name: wit_bindgen::rt::string_lift(bytes0),
                  ...
                  const _: () = {
                    ...
                    #[allow(non_snake_case)]
                    unsafe extern "C" fn __export_method_api_add_trader(arg0: i32,arg1: i64,arg2: i32,arg3: i32,) -> i32 {
                      #[allow(unused_imports)]
                      use wit_bindgen::rt::{alloc, vec::Vec, string::String};
                      ...
                      let len0 = arg3 as usize;
                      let bytes0 = Vec::from_raw_parts(arg2 as *mut _, len0, len0);
                      let result1 = <_ApiImpl as GuestApi>::add_trader(wit_bindgen::rt::Resource::<Api>::lift_borrow(arg0 as u32 as usize), super::super::super::super::sputnik::registry::api::Trader{
                        id: arg1 as u64,
                        name: wit_bindgen::rt::string_lift(bytes0),
                      });
                      let ptr2 = _RET_AREA.0.as_mut_ptr() as i32;
